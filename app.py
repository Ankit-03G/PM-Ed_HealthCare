...
# App UI
st.set_page_config(
    page_title="PM-Ed - Personalized Medical Education for Everyone",
    page_icon="🏥",
    layout="wide",
...
if page == "Home":
    ...
    <div class="hero-section">
        <h1>🏥 PM-Ed</h1>
        <p style="font-size: 1.2rem;">Personalized Medical Education for Everyone</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with col_a:
        ...
        <div class="card" style="text-align: center;">
            <h1 style="color: #3498db; font-size: 2.5rem;">{}</h1>
            <p>Patient Profiles</p>
        </div>
        """.format(len(st.session_state.patient_records)), unsafe_allow_html=True)
    ...
    with col_b:
        ...
        """.format(len(st.session_state.generated_materials)), unsafe_allow_html=True)
    ...
    with col_c:
        ...
        """.format(unique_conditions), unsafe_allow_html=True)
    ...
    with col_e:
        ...
        <div class="card">
            ...
            <ul>
                <li>Treatment adherence by up to 40%</li>
                <li>Patient satisfaction scores by 35%</li>
                <li>Health outcomes and reduced hospitalizations</li>
                <li>Patient engagement and self-management</li>
            </ul>
        </div>
        """, unsafe_allow_html=True)
